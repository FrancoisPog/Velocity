...
class ASTListeStations extends ASTNode {
    public ASTListeStations(int l, int c) {
        super("[ListeStations]", l, c);
    }
    @Override
...
class ASTStation extends ASTNode {
    public ASTStation(int l, int c) {
        super("[Station]", l, c);
    }
    @Override
    public Object accept(ASTNodeVisitor v) {
...
class ASTIdentificateur extends ASTNode {
    public ASTIdentificateur(String i, int l, int c) {
        super(i, l, c);
    }
    @Override
    public Object accept(ASTNodeVisitor v) {
